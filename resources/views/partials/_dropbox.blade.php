  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="text-center">Uploading Directions</h3>
      ...
      <div class="dropboxModalpad">
          <p><i class="fa fa-check-square-o"></i>Click on the “Upload” button below and you’ll be taken to our dropbox page; Nakissa &amp; Dom - Wedding Album.</p>
